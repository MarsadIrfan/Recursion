...
pprint.pprint('All files with even byte sizes:')
pprint.pprint(walk('.', hasEvenByteSize))
print()
pprint.pprint('All files with every vowel in their name:')
pprint.pprint(walk('.', hasEveryVowel))
